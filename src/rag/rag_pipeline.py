...
class RAGPipeline:
    ...
    def generate_qa_response(self, query: str) -> str:
        ...
        try:
            ...
            # Оптимизированный промпт для Llama 3.1
            template = """
            ...
            # Отладочная информация
            print(f"Отправляем запрос к модели Llama 3.1: {query}")
    ...
    def compare_opinions(self, query: str) -> str:
        ...
        try:
            ...
            # Создаем промпт для анализа, оптимизированный для Llama 3.1
            template = """
            ...
            # Отладочная информация
            print(f"Отправляем запрос к модели Llama 3.1 для сравнения мнений по теме: {query}")
